...
import { db, storage } from "./firebase"; // استيراد من ملف Firebase المنفصل
...
// ===== MOCK REQUESTS (للعرض فقط — استبدل بـ Firestore لاحقاً) =====
const MOCK_REQUESTS = [
...
export default function DriverDashboard({ user, onLogout }) {
  ...
  // ===== لوحة التحكم الرئيسية (للسائق الموثق فقط) =====
  const stats = [
